...
public class EstudioTattoo {
    ...
    public static void main(String[] args) {
        String strEscolhaEstilo, strEscolhaInformacao, strEstiloTattoo, strIndicacao = "", strInformacao, strNome="ESTUDIO TATTOO", strInf="Estudio de tatuagem em Sao Paulo", strOpEstilos = "1 - Blackwork\n2 - Dark\n3 - Fine Line\n4 - Geek\n5 - Lettering\n6 - Neotradicional\n7 - Ornamental\n8 - Realismo\n9 - Tradicional\n10 - Tradicional Americano\n11 - Tradicional Moderna\n";
        int intResposta, intPronto;
        ...
        if (intResposta == JOptionPane.YES_OPTION){
            ...
            while( ( strEstiloTattoo.equals("") ) || ( strEstiloTattoo.equals("OPCAO INVALIDA!") ) ) {
                ...
                strEscolhaEstilo = JOptionPane.showInputDialog("Escolha o numero do estilo de tatuagem que voce gostaria de fazer\n    ou digite 12 se quiser saber mais sobre algum dos estilo\n\n" + strOpEstilos + "12 - Me diga mais sobre um dos estilos\n\n");
            
                switch (strEscolhaEstilo) {
                ...
                if (strEstiloTattoo.equalsIgnoreCase("informacao")) {
                    ...
                    while (intPronto == JOptionPane.NO_OPTION) {
                        ...
                        strEscolhaInformacao = JOptionPane.showInputDialog("Digite o numero do estilo que voce quer informacao\n\n" +  strOpEstilos + "\n\n");
                        
                        switch (strEscolhaInformacao) {
